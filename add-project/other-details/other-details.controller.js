app.controller('otherDetailsCtrl', function($scope, $rootScope, ErrorMessage, LoadingIndicatorService, $localStorage, $location) {
   $scope.addOtherToProject = function(other) {
		try { 
